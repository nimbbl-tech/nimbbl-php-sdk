...
function printMenu()
{
    ...
    echo "16. Import Addresses\n";
    echo "17. Check Address Eligibility\n";
    echo "18. Link Order to Address\n";
    echo "\n" . Colors::YELLOW . "=== Refunds API ===\n" . Colors::RESET;
    echo "19. Initiate Refund\n";
    echo "\n" . Colors::YELLOW . "=== Transactions API ===\n" . Colors::RESET;
    echo "20. Transaction Enquiry\n";
    echo "\n" . Colors::YELLOW . "=== Checkout Utilities API ===\n" . Colors::RESET;
    echo "21. List Payment Modes\n";
    echo "22. List Banks\n";
    echo "23. List Wallets\n";
    echo "24. List EMIs\n";
    echo "25. Get Offers\n";
    echo "26. Get Card BIN Data\n";
    echo "27. Get Card Details\n";
    ...
    echo "32. Exception Handling Examples\n";
    echo "\n0.  Exit\n\n";
