...
echo "  • order-examples.php        - Create orders, get by ID, get by invoice ID\n\n";
...
echo "  • encryption-examples.php   - Data encryption/decryption examples\n";
...
echo "Tools:\n";
echo "  • cli.php                  - Interactive CLI menu for testing all APIs (32 options)\n\n";

echo str_repeat('=', 50) . "\n\n";
echo "To run a specific example:\n";
echo "  php example/generate-token.php\n";
echo "  php example/order-examples.php\n";
echo "  php example/payments-examples.php\n";
echo "  php example/webhook-handler.php\n\n";
echo "Or use the interactive CLI menu:\n";
echo "  php example/cli.php\n\n";
